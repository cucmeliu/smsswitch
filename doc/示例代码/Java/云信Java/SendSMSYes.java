	...
	public  boolean send(String mob, String msg) {
        ...
        try {
            ...
            HttpClient httpclient =new DefaultHttpClient();
             ...
             //构造一个post对象
             HttpPost httpPost = new HttpPost("http://yes.itissm.com/api/MsgSend.asmx/SendMsg");
             //添加所需要的post内容
             ...
             nvps.add(new BasicNameValuePair("Channel", "88"));//根据文档去获取
...
//        			 "POST",
//             		 "userCode=XXXX&userPass=XXXXX&DesNo="+mob+"&Msg="+msg+"&Channel=50");
